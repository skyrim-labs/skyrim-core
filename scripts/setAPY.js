...
async function main() {
  ...
  await dTrancheVault.setAPY(0, 50000); // 5%
  await dTrancheVault.setAPY(1, 150000);  // 15%
  const apyST = await dTrancheVault.getAPY(0);
  const apyJT = await dTrancheVault.getAPY(1);
