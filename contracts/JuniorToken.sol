    ...
    ERC20Upgradeable
{
    ...
    /**
     * @notice Ensure this is a junior token contract.
     */
    function isJuniorToken() external pure returns (bool) {
        return true;
    }
    ...
    /**
     * @dev Burn junior token due to loss.
     */
